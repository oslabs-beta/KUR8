...
export const metricsEndpointArray = (query, start, end) => [
  ...
  `http://localhost:9090/api/v1/query_range?query=rate(node_network_receive_bytes_total[1m])&start=2021-07-22T1:33:07.471Z&end=2021-07-22T04:33:07.471Z&step=15s`,
