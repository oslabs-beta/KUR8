...
export const NODE_FETCH_STARTED = 'NODE_FETCH_STARTED';
export const NODE_FETCH_COMPLETE = 'NODE_FETCH_COMPLETE';
...
export const METRICS_FETCH_STARTED = 'METRICS_FETCH_STARTED';
export const METRICS_FETCH_COMPLETE = 'METRICS_FETCH_COMPLETE';
export const CUSTOM_METRICS_FETCH_STARTED = 'CUSTOM_METRICS_FETCH_STARTED';
export const CUSTOM_METRICS_FETCH_COMPLETE = 'CUSTOM_METRICS_FETCH_COMPLETE';
...
export const ALERTS_FETCH_STARTED = 'ALERTS_FETCH_STARTED';
export const ALERTS_FETCH_COMPLETE = 'ALERTS_FETCH_COMPLETE';
