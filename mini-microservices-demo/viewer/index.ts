...
app.get('/podList', (req: Request, res: Response): void => {
  k8sApi
...
app.get('/serviceList', (req: Request, res: Response): void => {
  k8sApi
...
app.get('/ingressList', (req: Request, res: Response): void => {
  k8sApi
...
app.get('/deploymentList', (req: Request, res: Response): void => {
  k8sApi
